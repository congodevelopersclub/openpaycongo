...
| Vulnerability treatment | #38 | Sources, blocking criteria, exception authority/duration, remediation and disclosure rules | Approved policy and candidate-artifact review records |
...
All listed authority values are not yet approved. This matrix does not select
them.
...
| #48 identity/privacy/security | #38 | Threat and vulnerability decision packets; no approved exception policy | Do not close |
