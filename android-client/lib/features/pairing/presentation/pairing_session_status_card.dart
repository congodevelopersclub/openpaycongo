...
final class PairingSessionStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      BlocBuilder<PairingSessionBloc, PairingSessionState>(
        builder: (context, state) => Card(
          child: Padding(
            ...
            child: switch (state) {
              ...
              PairingSessionPending() => const Text(
                'Pairing awaits confirmation',
              ),
              PairingSessionActive() => const Text('Pairing is active'),
              PairingSessionOffline() => const Text('Pairing is offline'),
              PairingSessionRecoveryRequired() => const Text(
