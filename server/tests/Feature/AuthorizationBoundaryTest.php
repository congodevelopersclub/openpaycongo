...
final class AuthorizationBoundaryTest extends TestCase
{
    public function test_every_runtime_route_is_reviewed_as_public_or_authorized(): void
    {
        ...
        $authorizedRoutes = [
            ...
            'POST mobile/operator-sms/interpretation-requests' => ['auth:mobile', 'abilities:mobile:sync:write', 'mobile.activation', 'throttle:mobile-api'],
        ];
        ...
        $cryptographicPossessionRoutes = [
            ...
            // Directional AEAD key possession authenticates this route; a bearer credential is intentionally absent.
            'POST mobile/envelopes' => ['throttle:mobile-envelope'],
        ];
        $runtimeRouteCount = 0;
        ...
        self::assertSame(51, $runtimeRouteCount, 'Runtime route changes require an explicit authorization-boundary inventory review.');
    }
